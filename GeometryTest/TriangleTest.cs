...
public class TriangleTest
{
    ...
    public void InitTriangleTest()
    {
        ...
        Assert.Less(Math.Abs(triangle.EdgeA - a), CalculationConstants.CalculationAccuracy);
        Assert.Less(Math.Abs(triangle.EdgeB - b), CalculationConstants.CalculationAccuracy);
        Assert.Less(Math.Abs(triangle.EdgeC - c), CalculationConstants.CalculationAccuracy);
    }
    ...
    public void GetSquareTest()
    {
        ...
        Assert.Less(Math.Abs(square.Value - result), CalculationConstants.CalculationAccuracy);
    }
